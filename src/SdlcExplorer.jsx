...
const SdlcExplorer = () => {
  ...
  const getColorStyles = (type, isSelected) => {
    ...
    const selected = isSelected ? "ring-4 ring-offset-2 scale-110 z-20" : "hover:scale-105 hover:shadow-xl";
    switch (type) {
  ...
  const getPulseColor = (type) => {
    switch (type) {
        case 'developer': return 'border-green-400';
        case 'system': return 'border-red-400';
        case 'agent': return 'border-blue-400';
        case 'start': return 'border-yellow-400';
        case 'end': return 'border-emerald-400';
                        ...
                        >
                            ...
                            `}>
                                <div className="bg-transparent px-2 py-1">
                                    ...
                                    <h3 className={`text-2xl font-bold leading-tight mb-1 ${isSelected ? 'text-blue-700' : 'text-slate-600'}`}>
                                        {node.title}
                                    </h3>
